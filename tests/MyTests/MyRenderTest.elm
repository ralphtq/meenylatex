module MyTests.MyRenderTest exposing (..)
...
-- renderString2 : Internal.Parser.LatexExpression -> String -> String


-- renderString2 : Internal.Render.SourceText -> Html msg
renderString2 str =
    renderString Internal.LatexState.emptyLatexState str
    -- Debug.toString <| renderString Internal.LatexState.emptyLatexState str
...
--                 let
--                     renderOutput =
--                         renderString2 "% This is a comment\n"
...
--                 in
--                 Expect.equal renderOutput expectedOutput
--         , test "(4.1)  words and unimplemented macros" <|
--             \_ ->
--                 let
--                     renderOutput =
--                         renderString2
